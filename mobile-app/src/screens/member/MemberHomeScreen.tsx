        ...
        <View style={styles.headerActions}>
          {uploadQueue.total > 0 && (
            <TouchableOpacity
              style={[
                styles.queuePill,
                uploadQueue.needsAttention && styles.queuePillAttention,
              ]}
            ...
            >
              <Ionicons
                name={
                  uploadQueue.needsAttention
                    ? "alert-circle"
                    : "cloud-upload-outline"
                }
                size={16}
                color={uploadQueue.needsAttention ? "#B45309" : "#10B981"}
              />
              <Text
                style={[
                  styles.queuePillText,
                  uploadQueue.needsAttention && styles.queuePillTextAttention,
                ]}
              >
                {uploadQueue.total}
              </Text>
            ...
            <View style={styles.progressRingContainer}>
              ...
              <View
                style={[
                  ...
                  {
                    borderRightColor:
                      progress > 0.25 ? "rgba(255,255,255,0.9)" : "transparent",
                    borderBottomColor:
                      progress > 0.5 ? "rgba(255,255,255,0.9)" : "transparent",
                    borderLeftColor:
                      progress > 0.75 ? "rgba(255,255,255,0.9)" : "transparent",
                  },
                ]}
              />
              ...
              <View style={styles.ctaContent}>
                ...
                <View style={styles.ctaTextContainer}>
                  ...
                  <Text style={styles.ctaSubtitle}>
                    Your cleaning companion awaits
                  </Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  queuePillAttention: { backgroundColor: "#FEF3C7" },
  queuePillText: { fontSize: 14, fontWeight: "600", color: "#10B981" },
  queuePillTextAttention: { color: "#B45309" },
  settingsButton: {
    width: 44,
    height: 44,
    borderRadius: 22,
