  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.actionRow}>
        {queue.status.needsAssignment > 0 && (
          <TouchableOpacity
          ...
          >
            <Text style={styles.actionButtonPrimaryText}>
              Assign ({queue.status.needsAssignment})
            </Text>
          </TouchableOpacity>
        )}
        <TouchableOpacity
      ...
      <View style={styles.statusPanel}>
        ...
        <Text style={styles.statusLine}>
          Processing: {queue.isProcessing ? "yes" : "no"}
        </Text>
        <Text style={styles.statusLine}>
          Online: {queue.isOnline ? "yes" : "no"}
        </Text>
      </View>
        ...
        {queue.items.length === 0 ? (
          <View style={styles.emptyPanel}>
            ...
            <Text style={styles.emptyText}>
              New recordings will appear here while they are saved or uploading.
            </Text>
          </View>
        ) : (
                ...
                <View style={styles.itemHeader}>
                  <View style={styles.itemHeaderText}>
                    ...
                    <Text style={styles.itemMeta}>
                      Segment {item.segmentNumber} • {item.status} • stage{" "}
                      {item.stage}
                    </Text>
                    <Text style={styles.itemMeta}>
                      Progress {item.progress}% • Retries {item.retryCount}
                    </Text>
                    <Text style={styles.itemMeta}>
